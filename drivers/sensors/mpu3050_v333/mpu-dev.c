...
#ifdef CONFIG_OF
static const struct of_device_id mpu3050_dt_match[] = {
	{ .compatible = "invensense,mpu3050_v333" },
	{ },
};
MODULE_DEVICE_TABLE(of, mpu3050_dt_match);
#endif
...
static struct i2c_driver mpu3050_driver = {
	...
	.driver = {
		   .owner = THIS_MODULE,
		   .name = MPU_NAME,
			.of_match_table = of_match_ptr(mpu3050_dt_match),
		   },
