			       ...
			       const struct i2c_device_id *id)
{
	...
	input_mt_init_slots(input, MXT_MAX_NUM_TOUCHES, 0);
...
static const struct of_device_id mxt1386_dt_ids[] = {
